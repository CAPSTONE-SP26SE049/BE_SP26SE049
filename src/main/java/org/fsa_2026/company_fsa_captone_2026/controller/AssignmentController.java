...
public class AssignmentController {
        ...
        public ResponseEntity<ApiResponse<List<AssignmentDTO>>> getAssignmentsByStudent(
        ...
        public ResponseEntity<ApiResponse<List<AssignmentDTO>>> getAssignmentsByClassroom(
                        @PathVariable(name = "classroomId") UUID classroomId) {
                return ResponseEntity.ok(
        ...
        public ResponseEntity<ApiResponse<List<EducatorAssignmentDTO>>> getAssignmentsByEducator(
                        @PathVariable(name = "educatorId") UUID educatorId) {
                return ResponseEntity.ok(
        ...
        public ResponseEntity<ApiResponse<Void>> deleteAssignment(
                        Authentication authentication,
                        @PathVariable(name = "assignmentId") UUID assignmentId) {
